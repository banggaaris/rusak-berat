...
interface UploadHentiGunaProps {
...
export function UploadHentiGuna({ auth }: UploadHentiGunaProps) {
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            Upload Excel - Henti Guna
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-sm text-muted-foreground mb-4">
                            Format: <code className="bg-muted px-1 rounded">noSPPA</code>, <code className="bg-muted px-1 rounded">kodeUakpb</code>, <code className="bg-muted px-1 rounded">kodeBarang</code>, <code className="bg-muted px-1 rounded">namaBarang</code>, <code className="bg-muted px-1 rounded">noAwal</code>, <code className="bg-muted px-1 rounded">noAkhir</code>, <code className="bg-muted px-1 rounded">tglPerolehan</code>
                        </p>
                        <div
                                ...
                                <TableBody>
                                    {data.slice(0, 100).map((row, i) => (
                                        <TableRow key={i}>
                                            ...
                                            <TableCell className="font-mono text-xs">{row.noSPPA}</TableCell>

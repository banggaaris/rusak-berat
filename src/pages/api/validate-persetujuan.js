...
const SAKTI_API = 'https://fusesakti.kemenkeu.go.id/sakti/backend/asset-tetap/persetujuan/validationPersetujuanByProcedure';

export async function POST({ request }) {
    try {
        const body = await request.json();
        const { _headers, listPersetujuanWrapper } = body;
